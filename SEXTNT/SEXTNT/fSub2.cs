...
namespace SEXTNT
{
    public partial class fSub2 : Form
    {
        ...
        private void fClick(int nCol,int nRow)
        {
            ...
            int nType = Convert.ToInt32(fData(nCol, nRow));
            String sTwo;
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox1",
                Image = Image.FromFile(@"F castle.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture2 = new PictureBox
            {
                Name = "pictureBox2",
                Image = Image.FromFile(@"F field.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture3 = new PictureBox
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F prisoner.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
        ...
        private void btnComply_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 1; i <= 8; i++)
            {
                for (int j = 1; j <= 8; j++)
                {
                    nType = Convert.ToInt32(fData(i, j));
                    if (nType == 3)
                    {
                        bFound = true;
                        goto endline;
        ...
        private void fSub2_FormClosing(object sender, FormClosingEventArgs e)
        {
            timer1.Enabled = false;
        }
    }
